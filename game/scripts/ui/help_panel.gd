...
[color=#d0a85c]生産と建設[/color]
  兵舎・工廠・飛行場を選択 → Q W E … ユニット生産（Shift+クリックで5体）
  本拠地を選択 → B または CONSTRUCT … 建設メニュー（Q〜Y で建物を選び、地面をクリック）
  建設できるのは本拠地・城門・自軍の都市の周辺だけ。

[color=#d0a85c]勝利のために[/color]
  都市のリレー塔の輪の中に地上部隊を置くと占領できる（工兵は速い）。都市は資材・エーテル・人口上限をくれる。
  まずはアイアンスパイン門で4つの攻撃波を耐え、援軍到着後に中央ネクサスを奪い、ヴァルケシュ本拠地を破壊せよ。
  本拠地を失うと敗北。 F3 で FPS 表示、Esc でメニュー。"""
